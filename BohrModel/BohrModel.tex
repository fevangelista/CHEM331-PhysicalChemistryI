...
The ratio of the two masses is $M_p/m_e = 1836$, which shows that classically we can think of the hydrogen atom as a mini solar system with the proton having a fixed position in space (e.g. the origin) and the electron orbiting around it.\mnote{This approximation is not necessary, as we will see later, we can work in a set of reduced coordinates and treat both the motion of the proton and the electron.}
...
Assuming that the electron is in a stationary orbit, the force accelerating it towards the nucleus has magnitude
\begin{equation}
f_a = \frac{m_e v^2}{r}.
\end{equation}
...
Bohr's solution to this problem involved postulating that certain properties of the hydrogen atom can only take certain values.\mnote{Physicist Niels Bohr (Denmark, 1885--1962).}
\marginpar{
...
\begin{iequation}
E_n = - \frac{m_e e^4}{32 n^2\hbar^2 \pi^2 \epsilon_0^2 }.
\end{iequation}
